        ...
        <div class="students div w-full mt-3 p-4 flex flex-w gap-5">
            ...
            @foreach ($students as $stud)
                <div href="#"
                    ...
                    <div class=" p-4">
                        <svg class="object-cover w-full rounded-t-lg pl-0 ml-0 py-3 md:rounded-none md:rounded-s-lg"
                            fill="#000000" height="100px" width="100px" version="1.1" id="Layer_1"
                    ...
                    <div class="flex flex-col justify-between p-4 leading-normal">
                        ...
                        <a href="editstud/{{ $stud->id }}"
                            class="font-semibold text-sm text-center underline hover:no-underline hover:text-purple-500">Edit
                            Student Deatils
                        </a>
                    </div>
                </div>
