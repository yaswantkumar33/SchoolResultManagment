...
<div class="  w-full flex ">
    <div class="w-1/2 flex  items-Start px-5 pt-48  flex-col ">
        ...
        <div class="pt-6" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="1000">
            @if ($authh)
                <button type="button"
                    class="text-white bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-300  font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 font-playwrite">Dashbord</button>
            @else
                <button type="button"
